...
<div class="form-group">
    ...
    {!! Form::select('categories[]', $categories, old('categories[]') ? old('categories[]') : $post->categories->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-categories' ]) !!}
    @error('categories')
        <span class="invalid-feedback">{{ $message }}</span>
    @enderror
</div>
